...
<main class="main-bg">
    ...
    <section class="page-banner">
        <div class="page-banner-wrapper p-r z-1">
            ...
            <div class="shape shape-four"><span><img src="{{ asset('front/images/shape/stars.png') }}" alt=""></span></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                {!! $get_category->getParentsNamesShop() !!}
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-3">
                    ...
                    <div class="shop-sidebar-area">
                        ...
                        <div class="product-widget product-categories-widget mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1000">
                            <div class="widget-content">
                                ...
                                <ul class="categories-list">
                                    ...
                                    @foreach($value->childs as $inner_key => $inner_value)
                                    <li class="nested">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="{{ $inner_value->slug }}">
                                            <label class="form-check-label" for="{{ $inner_value->slug }}">{{ $inner_value->name }}<span>{{ $inner_value->product()->count() }}</span>
                                            </label>
                                        </div>
                                    </li>
                                    @endforeach
                        ...
                        <!--=== Sidebar Widget ===-->
                        <div class="product-widget price-filter-widget mb-40 wow fadeInUp" data-aos="fade-up" data-aos-delay="20" data-aos-duration="400">
                            <div class="widget-content">
                        ...
                        <!--=== Sidebar Widget ===-->
                        <div class="product-widget product-categories-widget mb-40" data-aos="fade-up" data-aos-delay="30" data-aos-duration="600">
                            <div class="widget-content">
                        ...
                        <div class="product-widget product-color-widget mb-30" data-aos="fade-up" data-aos-delay="40" data-aos-duration="800">
                            <div class="widget-content">
                        ...
                        <!--=== Sidebar Widget ===-->
                        <div class="product-widget product-size-widget mb-30" data-aos="fade-up" data-aos-delay="40" data-aos-duration="1000">
                            <div class="widget-content">
                                <h4 class="widget-title">Size</h4>
                                <ul class="size-list">
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="radio" value="Slim Fit" id="size1">
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="radio" value="Slim Fit" id="size7">
                        ...
                        <!--=== Sidebar Widget ===-->
                        <div class="sidebar-banner-widget mb-40" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                            <div class="banner-widget-content">
                                <div class="banner-shape"><img src="images/widget/banner-shape-1.png" alt="shape"></div>
                                <div class="banner-img"><img src="images/widget/banner-1.png" alt="image"></div>
                                <div class="content">
                    ...
                    <div class="shop-page-wrapper">
                        ...
                        <div class="shop-filter mb-60" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1000">
                            <div class="row align-items-center">
                                <div class="col-sm-5 col-12">
                                    <div class="show-text">
                                        <p><span>Showing</span>{{ $products->firstItem() }}-{{ $products->lastItem() }} of {{$products->total()}} Results</p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <!--=== Product Item  ===-->
                                <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="25" data-aos-duration="400">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pesco-pagination mb-40" data-aos="fade-up" data-aos-delay="70" data-aos-duration="2200">
