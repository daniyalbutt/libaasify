...
<footer class="footer-main">
    ...
    <div class="footer-bg-wrapper gray-bg">
        <div class="footer-shape shape-one"><span><img src="{{ asset('front/images/shape-1.png') }}" alt="shape"></span></div>
                            ...
                            <div class="widget-content">
                                ...
                                <ul class="ct-info-list mb-30">
                                    <li>
                                        ...
                                        <a href="{{ $helper->companyEmail() }}">{{ $helper->companyEmail() }}</a>
                                    </li>
                                    <li>
                                ...
                                <ul class="social-link">
                                    ...
                                    @if($helper->twitter() != '')
                                    <li>
                                        <a href="{{ $helper->twitter() }}" target="_blank"><i class="fab fa-twitter"></i></a>
                                    </li>
                                    @endif
                                </ul>
                            </div>
                        ...
                        <div class="footer-widget footer-nav-widget mb-40" data-aos="fade-up" data-aos-delay="15" data-aos-duration="1200">
                            <div class="widget-content">
                                ...
                                <ul class="widget-menu">
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Collections & Delivery</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Returns & Refunds</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Terms & Conditions</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Delivery Return</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Store Locations</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-sm-6">
                        ...
                        <div class="footer-widget footer-nav-widget mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                            <div class="widget-content">
                                ...
                                <ul class="widget-menu">
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Blogs</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Privacy Policy</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Terms Of Use</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">FAQ</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Contact</a></li>
                                    <li><img src="{{ asset('front/images/star-3.svg') }}" alt="star icon"><a href="#">Login / Register</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="payment-method text-lg-end">
                            <a href="#"><img src="{{ asset('front/images/payment-method.png') }}" alt="payment-method"></a>
                        </div>
                    </div>
                </div>
            </div>
